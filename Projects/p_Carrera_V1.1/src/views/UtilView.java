...
public class UtilView{
    ...
    public static boolean  isValidSecondName(String secondName){
        return (secondName.charAt(0) >= 65 && secondName.charAt(0) <= 90) || (secondName.charAt(0) >= 192 && secondName.charAt(0) <= 220);
    }
    ...
    public static String formatRunnerID(int id){
        return String.format("%d",id);
    }
    
    public static Object[] formatRunnerData(Object[] runnerData){
    	runnerData[0] = formatRunnerID((int)runnerData[0]);
    	runnerData[4] = formatLocalDate((LocalDate)runnerData[4]);
    	runnerData[5] = ((Gender)(runnerData[5])).getGender();
    	runnerData[6] = ((Team)(runnerData[6])).getName();
    	runnerData[7] = formatLocalTime((LocalTime)(runnerData[7]));
		return runnerData;
    }
