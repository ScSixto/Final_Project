...
public class View {
	...
	public static final char Ñ = (char)241;
	...
	public void showRunnerList(ArrayList<Object[]> runnerList) {
		System.out.println(SEPARATOR);
		System.out.println(String.format(RUNNER_LIST_FORMAT,"Id","Nombre1","Nombre2","Apellido","Genero","Equipo","Fecha de nacimiento","Edad","Tiempo de recorrio"));
		System.out.println(SEPARATOR);
		for (Object[] runner : runnerList) {
			System.out.println(String.format(RUNNER_LIST_FORMAT,runner[0],runner[1],runner[2],runner[3],runner[5],runner[6],runner[4],runner[8] + " a"+Ñ+"os.",runner[7]));
		}
		System.out.println(SEPARATOR);
	}
