...
public class EmployeeManager {
    ...
    public ArrayList<HashMap<EmployeeVariable, Object>> toHashMapList(){
    	ArrayList<HashMap<EmployeeVariable, Object>> employeeListHashmap = new ArrayList<>();
    	for (Employee employee : employeeList) {
    ...
    public void orderByRankingCategory(){
    	Collections.sort(employeeList, new Comparator<Employee>(){
			public int compare(Employee r1, Employee r2) {
				return r1.getRankingCategory().getText().compareToIgnoreCase(r2.getRankingCategory().getText());
			}
		});
    }
