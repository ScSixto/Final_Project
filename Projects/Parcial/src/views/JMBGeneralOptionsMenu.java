...
public class JMBGeneralOptionsMenu extends JMenuBar{
	...
	public static final String  LIST_SHOW_EMPLOYEE_LIST_OPTION_TEXT = "Mostrar lista de Empleados";
	public static final String  LIST_SHOW_EMPLOYEE_WINNER_LIST_OPTION_TEXT = "Mostrar Reporte";
	...
	private void addListMenu(ActionListener act) {
		...
		JMIMenuItemFormat showRunnerListItem = new JMIMenuItemFormat(LIST_SHOW_EMPLOYEE_LIST_OPTION_TEXT,MENU_ITEM_TEXT_FONT,MENU_ITEM_TEXT_FOREGROUND);
		showRunnerListItem.setActionCommand(ActionCommands.SHOW_EMPLOYEE_LIST.name());
		showRunnerListItem.addActionListener(act);
		listMenu.add(showRunnerListItem);

		JMIMenuItemFormat showWinnerListItem = new JMIMenuItemFormat(LIST_SHOW_EMPLOYEE_WINNER_LIST_OPTION_TEXT,MENU_ITEM_TEXT_FONT,MENU_ITEM_TEXT_FOREGROUND);
		showWinnerListItem.setActionCommand(ActionCommands.SHOW_EMPLOYEE_WINNER_LIST.name());
