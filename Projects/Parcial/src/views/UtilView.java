...
public class UtilView{
    ...
    public static ArrayList<Object[]> formatEmployeeData(ArrayList<Object[]> employeeData){
        for(Object[] employee: employeeData){
            ...
            employee[5] = formatEmployeeID((int)(employee[5]));
            employee[6] = formatEmployeeID((int)(employee[6]));
            employee[7] = formatDouble((double)(employee[7]));
            employee[8] = formatDouble((double)(employee[8]));
        }
		return employeeData;
    }
