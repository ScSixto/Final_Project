...
public class JPanelLanguage extends JPanel{
	...
	private void initComponents(ActionListener actionListener) {
		...
		add(createPanel(this.spanishLabel,"resources/img/BanderaEspa�a.png",50,30,actionListener,Commands.CHANGE_SPANISH.toString()));
		if(HandlerLanguage.languageProperties.getProperty(ConstantsGUI.LANGUAGE_ENGLISH).equals("Ingl�s"))
